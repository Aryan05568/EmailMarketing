...
// // Configure AWS SDK
// AWS.config.update({
//     accessKeyId: 'AKIA3DDR2ZJ7DWT6QRFQ',
//     secretAccessKey: 'BKMHFsCRI0o6zJWnRnvv5mGNTvaUJOUg1lTUbyw5t1PN',
//     region: 'ap-south-1'
// });
...
//         await ses.createConfigurationSet(params).promise();
...
// // Add event destinations for tracking delivery, bounces, complaints, opens
...
//         await ses.createConfigurationSetEventDestination(cloudWatchParams).promise();
...
// function createTransporter({ smtpServer, smtpPort, emailUser, emailPass, delayBetweenEmails, configurationSet }) {
//     return nodemailer.createTransport({
...
//                     await storeEmailTracking(campaignId, email, result.messageId);
//                 } catch (err) {
//                     retries--;
//                     if (retries < 0) throw err;
//                     await new Promise(r => setTimeout(r, 1000));
...
//         // Insert into your tracking table
...
//         // await supabase.from('email_tracking').insert([trackingData]);
...
// // Get campaign statistics from CloudWatch
...
const sesClient = new SESClient({
    region: 'ap-south-1',
    credentials: {
        accessKeyId: process.env.AWS_ACCESS_KEY_ID || 'AKIA3DDR2ZJ7CETER6CY',
        secretAccessKey: process.env.AWS_SECRET_ACCESS_KEY || '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'
    }
});
...
//             console.warn('Missing required parameters for email tracking');
//             return {
//                 success: false,
//                 error: 'Missing required parameters',
//                 message: 'Email tracking skipped due to missing parameters'
//             };
//         }
...
//         // Simple insert - no upsert, no ON CONFLICT
//         const { data, error } = await supabase
//             .from('email_tracking')
//             .insert([trackingData])
//             .select();
...
//         //         console.log(`Duplicate tracking record for ${recipientEmail} in campaign ${campaignId} - skipping`);
//         //         return {
//         //             success: true,
//         //             data: null,
...
//         //     // For other errors, log but don't fail the email sending
//         //     console.error('Email tracking insert error:', error.message);
//         //     return {
//         //         success: false,
//         //         error: error.message,
//         //         message: 'Tracking failed but email sending continues'
//         //     };
//         // }

//         console.log(`Email tracking stored for: ${recipientEmail}`);
//         console.log(error)
//         return {
//             success: true,
//             data: data && data.length > 0 ? data[0] : null,
//             message: 'Email tracking stored successfully'
//         };

//     } catch (error) {
//         console.error('Error in storeEmailTracking:', error.message);
//         return {
//             success: false,
//             error: error.message,
//             message: 'Tracking failed but email sending continues'
...
//                     console.log(`Duplicate record detected for ${recipientEmail}, attempting update instead`);
...
//                     if (updateError) {
//                         throw new Error(`Database update error after duplicate: ${updateError.message}`);
//                     }

//                     return {
//                         success: true,
//                         data: updateData[0],
//                         message: 'Email tracking data updated after duplicate detection'
//                     };
//                 }
...
//         // Use upsert - requires a unique constraint on the table
//         const { data, error } = await supabase
//             .from('email_tracking')
//             .upsert([trackingData])
//             .select();
...
//         console.log('Email tracking data stored/updated successfully for:', recipientEmail);
//         return {
//             success: true,
//             data: data[0],
//             message: 'Email tracking data stored/updated successfully'
//         };
